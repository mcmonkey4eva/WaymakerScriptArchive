...
# - Add a list of heads to plugins/Denizen/data/head_list.yml (key name 'heads', list of maps with keys 'title', 'uuid', 'value', and 'tags')
# If you need a heads list, here's a list file of about 35 thousand heads from minecraft-heads.com: https://cdn.discordapp.com/attachments/123/123/head_list.yml
    ...
    - else:
        ...
        - else:
            ...
            - foreach <[headmegalist]> as:one_head_map:
                - define title <[one_head_map.title]>
                - define tags <[one_head_map.tags]>
...
head_get_item_proc:
    ...
    script:
    - definemap adjusts:
        skull_skin: <[one_head_map.uuid]>|<[one_head_map.value]>
        display: <[one_head_map.title]>
    - determine <item[player_head].with_map[<[adjusts]>]>
